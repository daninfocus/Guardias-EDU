...
function Login() {
  ...
  return (
    <div className="flex flex-col h-full items-center justify-center bg-green">
      <p className="font-normal text-5xl mb-16">Guardias-EDU</p>
      <iframe className="h-3/6" src="https://embed.lottiefiles.com/animation/101662"></iframe>
      ...
      <div className="flex">
        <button
          ...
          className="hover:bg-red-500 rounded-xl p-2.5 hover:text-white"
        >
